...
/*
 🔴 BaseVC에 상속받은 객체에서 NWPathMonitor 객체를 생성하게 된다면 상속 받게된 모든 VC에서 싱글톤으로 인해 NetworkMonitor 객체를 생성하게 됌
 리소스 낭비 EX) 100개 만들고 100개 지우는 작업 필요
 
 ==> 🟢 SceneDelegate에서 하면 최상위 뷰를 찾고 하는 과정 필요 없어짐
 */
